...
const TravelTourismPage = () => {
	...
	return (
		<>
			<Helmet>
				<title>T15 Media | Travel and Tourism Content</title>
				<meta
					name="description"
					content="We started our journey creating travel and tourism based content, so it’s safe to say you’re in good hands. From exciting campaigns promoting new flight destinations to epic hero videos for tourism boards, we have you covered!"></meta>
				<meta name="robots" content="index,follow"></meta>
				<meta
					property="og:title"
					content="T15 Media | Travel and Tourism Content"
				/>
				<meta property="og:url" content="https://t15media.com/travel-tourism" />
				<meta
					property="og:image"
				...
				<meta
					...
					content="We started our journey creating travel and tourism based content, so it’s safe to say you’re in good hands. From exciting campaigns promoting new flight destinations to epic hero videos for tourism boards, we have you covered!"
				/>
